...
main(int argc, char **argv)
{
  ...
  34:	320080e7          	jalr	800(ra) # 350 <kill>
  for(i=1; i<argc; i++)
  ...
  4c:	82058593          	addi	a1,a1,-2016 # 868 <malloc+0xec>
  50:	4509                	li	a0,2
  52:	00000097          	auipc	ra,0x0
  56:	644080e7          	jalr	1604(ra) # 696 <fprintf>
    exit(1);
  5a:	4505                	li	a0,1
...
stat(const char *n, struct stat *st)
{
 ...
 1d8:	18e080e7          	jalr	398(ra) # 362 <open>
  if(fd < 0)
 ...
 1e8:	186080e7          	jalr	390(ra) # 36a <fstat>
 1ec:	892a                	mv	s2,a0
  close(fd);
 1ee:	8526                	mv	a0,s1
 1f0:	00000097          	auipc	ra,0x0
 1f4:	158080e7          	jalr	344(ra) # 348 <close>
  return r;
}
 1f8:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 402:	f40080e7          	jalr	-192(ra) # 33e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 436:	4ae50513          	addi	a0,a0,1198 # 8e0 <digits>
 43a:	883a                	mv	a6,a4
 ...
 45a:	fec7f0e3          	bgeu	a5,a2,43a <printint+0x2c>
  if(neg)
 45e:	00088c63          	beqz	a7,476 <printint+0x68>
    buf[i++] = '-';
 ...
 472:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 476:	02e05663          	blez	a4,4a2 <printint+0x94>
 47a:	fc040913          	addi	s2,s0,-64
 47e:	993a                	add	s2,s2,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f2:	39ac8c93          	addi	s9,s9,922 # 888 <malloc+0x10c>
 ...
 500:	3e4b8b93          	addi	s7,s7,996 # 8e0 <digits>
 ...
 568:	eaa080e7          	jalr	-342(ra) # 40e <printint>
 56c:	8b4a                	mv	s6,s2
      } else {
 ...
 5c0:	e30080e7          	jalr	-464(ra) # 3ec <putc>
  putc(fd, 'x');
 5c4:	07800593          	li	a1,120
 5c8:	8556                	mv	a0,s5
 5ca:	00000097          	auipc	ra,0x0
 5ce:	e22080e7          	jalr	-478(ra) # 3ec <putc>
 5d2:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 5e4:	e0c080e7          	jalr	-500(ra) # 3ec <putc>
 ...
 610:	de0080e7          	jalr	-544(ra) # 3ec <putc>
          s++;
 ...
 626:	25e98993          	addi	s3,s3,606 # 880 <malloc+0x104>
        while(*s != 0){
 62a:	85ee                	mv	a1,s11
 ...
 63c:	db4080e7          	jalr	-588(ra) # 3ec <putc>
 640:	8b4a                	mv	s6,s2
      state = 0;
 642:	4981                	li	s3,0
 ...
 64e:	da2080e7          	jalr	-606(ra) # 3ec <putc>
      state = 0;
 652:	4981                	li	s3,0
 ...
 65e:	d92080e7          	jalr	-622(ra) # 3ec <putc>
        putc(fd, c);
 662:	85ca                	mv	a1,s2
 664:	8556                	mv	a0,s5
...
free(void *ap)
{
 ...
 708:	1f47b783          	ld	a5,500(a5) # 8f8 <freep>
 ...
 730:	00e6ea63          	bltu	a3,a4,744 <free+0x4a>
{
 ...
 772:	18f73523          	sd	a5,394(a4) # 8f8 <freep>
}
 776:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 79a:	00148a1b          	addiw	s4,s1,1
 79e:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
 7a0:	00000517          	auipc	a0,0x0
 7a4:	15853503          	ld	a0,344(a0) # 8f8 <freep>
 ...
 7aa:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 7ac:	4798                	lw	a4,8(a5)
 7ae:	04977163          	bgeu	a4,s1,7f0 <malloc+0x74>
 7b2:	89d2                	mv	s3,s4
 7b4:	000a071b          	sext.w	a4,s4
 7b8:	6685                	lui	a3,0x1
 7ba:	00d77363          	bgeu	a4,a3,7c0 <malloc+0x44>
 7be:	6985                	lui	s3,0x1
 7c0:	00098b1b          	sext.w	s6,s3
  p = sbrk(nu * sizeof(Header));
 7c4:	0049999b          	slliw	s3,s3,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 7cc:	13090913          	addi	s2,s2,304 # 8f8 <freep>
  if(p == (char*)-1)
 7d0:	5afd                	li	s5,-1
 7d2:	a8a5                	j	84a <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 7d4:	00000797          	auipc	a5,0x0
 7d8:	12478793          	addi	a5,a5,292 # 8f8 <freep>
 7dc:	00000717          	auipc	a4,0x0
 7e0:	12470713          	addi	a4,a4,292 # 900 <base>
 7e4:	e398                	sd	a4,0(a5)
 7e6:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 7e8:	0007a823          	sw	zero,16(a5)
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7ec:	87ba                	mv	a5,a4
 7ee:	b7d1                	j	7b2 <malloc+0x36>
      if(p->s.size == nunits)
 7f0:	02e48c63          	beq	s1,a4,828 <malloc+0xac>
        p->s.size -= nunits;
 7f4:	4147073b          	subw	a4,a4,s4
 7f8:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ...
 802:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 804:	0147a423          	sw	s4,8(a5)
      freep = prevp;
 808:	00000717          	auipc	a4,0x0
 80c:	0ea73823          	sd	a0,240(a4) # 8f8 <freep>
      return (void*)(p + 1);
 ...
 83c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 840:	d971                	beqz	a0,814 <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 842:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 844:	4798                	lw	a4,8(a5)
 846:	fa9775e3          	bgeu	a4,s1,7f0 <malloc+0x74>
    if(p == freep)
 84a:	00093703          	ld	a4,0(s2)
 84e:	853e                	mv	a0,a5
 850:	fef719e3          	bne	a4,a5,842 <malloc+0xc6>
  p = sbrk(nu * sizeof(Header));
 854:	854e                	mv	a0,s3
 856:	00000097          	auipc	ra,0x0
 85a:	b3e080e7          	jalr	-1218(ra) # 394 <sbrk>
  if(p == (char*)-1)
 85e:	fd5518e3          	bne	a0,s5,82e <malloc+0xb2>
        return 0;
 862:	4501                	li	a0,0
 864:	bf45                	j	814 <malloc+0x98>
