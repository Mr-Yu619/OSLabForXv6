...
int readline(int fd, char *buf, int len)
{
  ...
  2c:	460080e7          	jalr	1120(ra) # 488 <read>
...
int main(int argc, char *argv[])
{
 ...
 11c:	8a058593          	addi	a1,a1,-1888 # 9b8 <malloc+0xea>
 120:	4509                	li	a0,2
 122:	00000097          	auipc	ra,0x0
 126:	6c6080e7          	jalr	1734(ra) # 7e8 <fprintf>
        exit(-1);
 12a:	557d                	li	a0,-1
 ...
 15a:	354080e7          	jalr	852(ra) # 4aa <exec>
            printf("xargs: exec %s fail\n", argv[1]);
 15e:	00893583          	ld	a1,8(s2)
 162:	00001517          	auipc	a0,0x1
 166:	87e50513          	addi	a0,a0,-1922 # 9e0 <malloc+0x112>
 16a:	00000097          	auipc	ra,0x0
 16e:	6ac080e7          	jalr	1708(ra) # 816 <printf>
            exit(0);
 172:	4501                	li	a0,0
 ...
 194:	31a080e7          	jalr	794(ra) # 4aa <exec>
                printf("xargs: exec %s fail\n", argv[1]);
 198:	00893583          	ld	a1,8(s2)
 19c:	00001517          	auipc	a0,0x1
 1a0:	84450513          	addi	a0,a0,-1980 # 9e0 <malloc+0x112>
 1a4:	00000097          	auipc	ra,0x0
 1a8:	672080e7          	jalr	1650(ra) # 816 <printf>
                exit(0);
 1ac:	4501                	li	a0,0
...
gets(char *buf, int max)
{
 ...
 2d6:	1b6080e7          	jalr	438(ra) # 488 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 32a:	18e080e7          	jalr	398(ra) # 4b4 <open>
  if(fd < 0)
 ...
 33a:	186080e7          	jalr	390(ra) # 4bc <fstat>
 33e:	892a                	mv	s2,a0
  close(fd);
 340:	8526                	mv	a0,s1
 342:	00000097          	auipc	ra,0x0
 346:	158080e7          	jalr	344(ra) # 49a <close>
  return r;
}
 34a:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 554:	f40080e7          	jalr	-192(ra) # 490 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 588:	4d450513          	addi	a0,a0,1236 # a58 <digits>
 58c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 644:	3c0c8c93          	addi	s9,s9,960 # a00 <malloc+0x132>
 ...
 778:	28498993          	addi	s3,s3,644 # 9f8 <malloc+0x12a>
        while(*s != 0){
 77c:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 85a:	21a7b783          	ld	a5,538(a5) # a70 <freep>
 ...
 882:	00e6ea63          	bltu	a3,a4,896 <free+0x4a>
{
 ...
 8c4:	1af73823          	sd	a5,432(a4) # a70 <freep>
}
 8c8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8f6:	17e53503          	ld	a0,382(a0) # a70 <freep>
 ...
 91e:	15690913          	addi	s2,s2,342 # a70 <freep>
  if(p == (char*)-1)
 922:	5afd                	li	s5,-1
 924:	a8a5                	j	99c <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 926:	00000797          	auipc	a5,0x0
 92a:	14a78793          	addi	a5,a5,330 # a70 <freep>
 92e:	00000717          	auipc	a4,0x0
 932:	14a70713          	addi	a4,a4,330 # a78 <base>
 936:	e398                	sd	a4,0(a5)
 938:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 ...
 9ac:	b3e080e7          	jalr	-1218(ra) # 4e6 <sbrk>
  if(p == (char*)-1)
