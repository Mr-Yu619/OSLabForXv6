...
int main(int argc, char *argv[])
{
  ...
  20:	99458593          	addi	a1,a1,-1644 # 9b0 <malloc+0xee>
  24:	4509                	li	a0,2
  26:	00000097          	auipc	ra,0x0
  2a:	7b6080e7          	jalr	1974(ra) # 7dc <fprintf>
        exit(1);
  2e:	4505                	li	a0,1
  ...
  60:	44c080e7          	jalr	1100(ra) # 4a8 <open>
  64:	84aa                	mv	s1,a0
    if (fd >= 0) {
  ...
  72:	442080e7          	jalr	1090(ra) # 4b0 <fstat>
        close(fd);
  76:	8526                	mv	a0,s1
  ...
  92:	97a58593          	addi	a1,a1,-1670 # a08 <malloc+0x146>
  96:	4509                	li	a0,2
  98:	00000097          	auipc	ra,0x0
  9c:	744080e7          	jalr	1860(ra) # 7dc <fprintf>
            exit(-1);
  a0:	557d                	li	a0,-1
 ...
 13c:	89858593          	addi	a1,a1,-1896 # 9d0 <malloc+0x10e>
 140:	4509                	li	a0,2
 142:	00000097          	auipc	ra,0x0
 146:	69a080e7          	jalr	1690(ra) # 7dc <fprintf>
                    exit(-1);
 14a:	557d                	li	a0,-1
 ...
 164:	8c050513          	addi	a0,a0,-1856 # a20 <malloc+0x15e>
 168:	00000097          	auipc	ra,0x0
 16c:	6a2080e7          	jalr	1698(ra) # 80a <printf>
    if (rename(src, dst) < 0) {
 170:	85ca                	mv	a1,s2
 172:	8526                	mv	a0,s1
 174:	00000097          	auipc	ra,0x0
 178:	3b6080e7          	jalr	950(ra) # 52a <rename>
 ...
 192:	8aa58593          	addi	a1,a1,-1878 # a38 <malloc+0x176>
 196:	4509                	li	a0,2
 198:	00000097          	auipc	ra,0x0
 19c:	644080e7          	jalr	1604(ra) # 7dc <fprintf>
        exit(-1);
 1a0:	557d                	li	a0,-1
...
gets(char *buf, int max)
{
 ...
 2ca:	1b6080e7          	jalr	438(ra) # 47c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31e:	18e080e7          	jalr	398(ra) # 4a8 <open>
  if(fd < 0)
 ...
 32e:	186080e7          	jalr	390(ra) # 4b0 <fstat>
 332:	892a                	mv	s2,a0
  close(fd);
 334:	8526                	mv	a0,s1
...
putc(int fd, char c)
{
 ...
 548:	f40080e7          	jalr	-192(ra) # 484 <write>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 638:	42cc8c93          	addi	s9,s9,1068 # a60 <malloc+0x19e>
 ...
 646:	476b8b93          	addi	s7,s7,1142 # ab8 <digits>
 ...
 76c:	2f098993          	addi	s3,s3,752 # a58 <malloc+0x196>
        while(*s != 0){
 770:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 84e:	2867b783          	ld	a5,646(a5) # ad0 <freep>
 ...
 876:	00e6ea63          	bltu	a3,a4,88a <free+0x4a>
{
 ...
 8b8:	20f73e23          	sd	a5,540(a4) # ad0 <freep>
}
 8bc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8ea:	1ea53503          	ld	a0,490(a0) # ad0 <freep>
 ...
 912:	1c290913          	addi	s2,s2,450 # ad0 <freep>
  if(p == (char*)-1)
 916:	5afd                	li	s5,-1
 918:	a8a5                	j	990 <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 91a:	00000797          	auipc	a5,0x0
 91e:	1b678793          	addi	a5,a5,438 # ad0 <freep>
 922:	00000717          	auipc	a4,0x0
 926:	1b670713          	addi	a4,a4,438 # ad8 <base>
 92a:	e398                	sd	a4,0(a5)
 92c:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 ...
 952:	18a73123          	sd	a0,386(a4) # ad0 <freep>
      return (void*)(p + 1);
 ...
 9a0:	b3e080e7          	jalr	-1218(ra) # 4da <sbrk>
  if(p == (char*)-1)
